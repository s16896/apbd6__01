    ...
    public partial class Hospital : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "test@gmail.com", "first", "Doctor" },
                    { 2, "testte@gmail.com", "second", "Biologist" },
                    { 3, "test@gmail.com", "third", "Pediatrician" },
                    { 4, "test@gmail.com", "firstsecond", "Psychiatrist" },
                    { 5, "test@gmail.com", "none", "Anesthesiologist" },
                    { 6, "test@gmail.com", "none", "Diabetes" }
                });
